...
SCRIPT_VERSION = "sensor_mvp_api_gt_sensor_only_step3_motion_dir_v20260310"
...
class SensorEstimator:
    def __init__(
        ...
        self.prev_lane_dir_sign: float = 1.0

    def reset(self):
        self.prev_clusters = []
        self.prev_ts = None
        self.prev_ego_xy = None
        self.prev_lane_dir_sign = 1.0
    ...
    def _estimate_lane_from_points(
        ...
        # choose lane tangent sign that better matches ego motion direction.
