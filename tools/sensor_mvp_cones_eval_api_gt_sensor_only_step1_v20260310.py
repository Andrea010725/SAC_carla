...
SCRIPT_VERSION = "sensor_mvp_api_gt_sensor_only_step1_v20260310"
...
class SensorEstimator:
    ...
    def _estimate_lane_from_points(
        ...
        # Keep prediction side sensor-only: do not use target waypoint/map semantics here.
        # Direction is defined as ego-forward in this MVP.
        dir_sign = 1.0
