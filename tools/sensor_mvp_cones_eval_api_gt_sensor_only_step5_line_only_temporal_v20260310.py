...
SCRIPT_VERSION = "sensor_mvp_api_gt_sensor_only_step5_line_only_temporal_v20260310"
LANE_LOOKAHEAD_FIXED_M = 12.0
LANE_DIR_MOTION_MIN_STEP_M = 0.10
LANE_DIR_OPPOSITE_MOTION = True
LANE_LINE_SLICE_MIN_POINTS = 6
LANE_LINE_SIDE_MIN_POINTS = 2
LANE_WIDTH_VALID_MIN_M = 2.0
LANE_WIDTH_VALID_MAX_M = 6.0
...
class SensorEstimator:
    ...
    def estimate(
        ...
        if np.isfinite(float(lane[2])) and float(lane[2]) > 1e-3:
